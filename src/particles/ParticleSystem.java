...
public class ParticleSystem {
	...
	public ParticleSystem( ParticleTexture texture, float pps, float speed, float gravityComplient, float lifeLength, float scale, Vector3f position ) 
	{
		this( texture, pps, speed, gravityComplient, lifeLength, scale );
