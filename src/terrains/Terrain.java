...
public class Terrain {
    ...
    public Terrain( int gridX, int gridZ, Loader loader, TerrainTexturePack texturePack, TerrainTexture blendMap, String heightMap, String fileName )
    {
    	this.texturePack 	= texturePack;
        this.blendMap 		= blendMap;
        this.x 				= gridX * SIZE;
        this.z 				= gridZ * SIZE;
        generator 			= new HeightsGenerator( gridX, gridZ, VERTEX_COUNT, SEED, fileName );
        this.model 			= generateTerrain( loader, heightMap );
    }
